...
@include('template.form_sidebar')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Narrations</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Narrations</a></li>
                                <li class="breadcrumb-item active">Narrations List</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                            <div class="col-lg-12">
                                        ...
                                        <div id="customerList">
                                            <div class="row g-4 mb-3">
                                                <div class="col-sm-auto">
                                                    <div>
                                                    <a href="{{ route('narrations.create') }}" class="btn btn-success add-btn btn-sm">
                                ...
                                <table class="table align-middle table-nowrap" id="narrationsTable">
...
<script>
$(function () {
    var table = $('#narrationsTable').DataTable({
    processing: true,
    serverSide: true,
    lengthChange: true,
    searching: true,
    paging: true,
    info: true,
    ajax: "{{ route('narrations.data') }}",
   
    columns: [
        { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false },
        { data: 'narration_name', name: 'narration_name', orderable: false },
    ...
    $('#editNarrationForm').on('submit', function(e) {
        e.preventDefault();
        var form = $(this);
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#narrationsTable').DataTable().ajax.reload();
            ...
            error: function(xhr, status, error) {
                toastr.error('An error occurred while updating the narration.', 'Error', {
                    positionClass: 'toast-top-right',
                    timeOut: 5000,
                });
            }
  ...
  $('#deleteRecordModal').on('show.bs.modal', function(event) {
        ...
        var deleteUrl = '{{ route("narrations.destroy", ":id") }}';
