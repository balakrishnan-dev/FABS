                                        ...
                                        <div id="customerList">
                                            <div class="row g-4 mb-3">
                                                <div class="col-sm-auto">
                                                    <div>
                                                    <a href="{{ route('roles.create') }}" class="btn btn-success add-btn btn-sm">
...
$(function () {
    ...
    ajax: "{{ route('roles.data') }}",
        ...
        { data: 'name', name: 'name', orderable: true, searchable: true },           // Date From
    ...
    $('#editRoleForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                toastr.error('An error occurred while updating the roles.', 'Error', {
                    positionClass: 'toast-top-right',
                    timeOut: 5000,
                });
            }
