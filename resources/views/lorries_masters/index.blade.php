                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Lorry</a></li>
                            ...
                            <div id="customerList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <div>
                                            <a href="{{ route('lorries_masters.create') }}" class="btn btn-success add-btn btn-sm">
                                ...
                                <table class="table align-middle table-nowrap" id="lorriesTable">
...
var table = $('#lorriesTable').DataTable({
    processing: true,
    serverSide: true,
    ajax: '{{ route("lorries_masters.data") }}',
    columns: [
    ...
    $('#editlorriesForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#lorriesTable').DataTable().ajax.reload();
            ...
            error: function(xhr, status, error) {
                toastr.error('An error occurred while updating the lorries.', 'Error', {
                    positionClass: 'toast-top-right',
                    timeOut: 5000,
                });
            }
  ...
  $('#deleteRecordModal').on('show.bs.modal', function(event) {
        ...
        var deleteUrl = '{{ route("lorries_masters.destroy", ":id") }}';
