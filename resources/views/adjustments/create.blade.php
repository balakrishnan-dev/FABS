                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Add Adjustment Entry</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Add Adjustment Entry</h4>
                        </div><!-- end card header -->
                            ...
                            <div class="live-preview">
                                <form action="{{ route('adjustments.store') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="ledger" class="form-control" value="{{ old('ledger') }}">
                                        @error('ledger')
                                            <div class="text-danger mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
