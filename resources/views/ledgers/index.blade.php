                        ...
                        <div class="card-body">
                            <div id="ledgerList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <a href="{{ route('ledgers.create') }}" class="btn btn-success btn-sm">
                                ...
                                <table class="table align-middle table-nowrap" id="LedgerTable">
                            ...
                            <div class="noresult d-none">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted">No matching ledgers found.</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
$(function () {
    ...
    $('#deleteRecordModal').on('show.bs.modal', function(event) {
        ...
        var deleteUrl = '{{ route("ledgers.destroy", ":id") }}'.replace(':id', recordId);
