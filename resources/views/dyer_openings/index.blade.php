        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Dyer Openings</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Dyer Openings</a></li>
                                <li class="breadcrumb-item active">Dyer Openings</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div id="dyer_openingsList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <div>
                                            <a href="{{ route('dyer_openings.create') }}" class="btn btn-success add-btn btn-sm">
                                ...
                                <table class="table align-middle table-nowrap" id="dyerOpeningsTable">
...
<script>
$(function () {
    var table = $('#dyerOpeningsTable').DataTable({
        processing: true,
        serverSide: true,
        lengthChange: true,
        searching: true,
        paging: true,
        info: true,
        ajax: "{{ route('dyer_openings.data') }}",
        columns: [
            { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false },
            { data: 'dyer_name', name: 'dyer_name', orderable: false },
    ...
    $('#deleteRecordModal').on('show.bs.modal', function(event) {
        ...
        var deleteUrl = '{{ route("dyer_openings.destroy", ":id") }}';
