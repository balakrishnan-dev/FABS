                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                        ...
                                        <div id="customerList">
                                            <div class="row g-4 mb-3">
                                                <div class="col-sm-auto">
                                                    <div>
                                                    <a href="{{ route('permissions.create') }}" class="btn btn-success add-btn btn-sm">
                                    ...
                                    <div class="table-responsive"> <!-- Added table-responsive class -->
                                       <table class="table align-middle table-nowrap" id="permissionsTable">
    ...
    $('#editpermissionsForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                toastr.error('An error occurred while updating the permissions.', 'Error', {
                    positionClass: 'toast-top-right',
                    timeOut: 5000,
                });
            }
