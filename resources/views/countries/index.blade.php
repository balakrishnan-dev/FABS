            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Countries & Currency</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Country</a></li>
                                <li class="breadcrumb-item active">Countries & Currency List</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div id="countryList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <div>
                                            <a href="{{ route('countries.create') }}" class="btn btn-success add-btn btn-sm">
                                ...
                                <table class="table align-middle table-nowrap" id="countriesTable">
...
$(function () {
    var table = $('#countriesTable').DataTable({
        ...
        columns: [
            ...
            { data: 'country_name', name: 'country_name', orderable: false },
            { data: 'currency_name', name: 'currency_name', orderable: false },
    ...
    $('#deleteRecordModal').on('show.bs.modal', function(event) {
        ...
        var deleteUrl = '{{ route("countries.destroy", ":id") }}';
