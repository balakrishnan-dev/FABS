...
@include('template.form_sidebar')
            ...
            <div class="row">
                            <div class="col-lg-12">
                                        ...
                                        <div id="customerList">
                                            <div class="row g-4 mb-3">
                                                <div class="col-sm-auto">
                                                    <div>
                                                    <a href="{{ route('process.create') }}" class="btn btn-success add-btn btn-sm">
                                ...
                                <table class="table align-middle table-nowrap" id="ProcessTable">
...
$(function () {
    ...
    paging: true,
    info: true,
    ajax: "{{ route('process.data') }}",
   
    columns: [
        { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false },
        { data: 'process_name', name: 'process_name', orderable: false },
        { data: 'description', name: 'description', orderable: false },
        { data: 'coolie_per_mtr', name: 'coolie_per_mtr', orderable: false },
    ...
    $('#editProcessForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                toastr.error('An error occurred while updating the process.', 'Error', {
                    positionClass: 'toast-top-right',
                    timeOut: 5000,
                });
            }
  ...
  $('#deleteRecordModal').on('show.bs.modal', function(event) {
        ...
        var deleteUrl = '{{ route("process.destroy", ":id") }}';
