            ...
            <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                        ...
                                        <div id="customerList">
                                            <div class="row g-4 mb-3">
                                                <div class="col-sm-auto">
                                                    <div>
                                                    <a href="{{ route('options.create') }}" class="btn btn-success add-btn btn-sm">
                                    ...
                                    <table class="table align-middle table-nowrap" id="optionsTable">
...
$(function () {
    ...
    ajax: "{{ route('options.data') }}",
        ...
        { data: 'option_name', name: 'option_name', orderable: true, searchable: true },           // Date From
        { data: 'value', name: 'value', orderable: true, searchable: true },               // Date To
    ...
    $('#editOptionsForm').on('submit', function(e) {
        e.preventDefault();
        var form = $(this);
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#optionsTable').DataTable().ajax.reload();
            ...
            error: function(xhr, status, error) {
                toastr.error('An error occurred while updating the options.', 'Error', {
                    positionClass: 'toast-top-right',
                    timeOut: 5000,
                });
            }
  ...
  $('#deleteRecordModal').on('show.bs.modal', function(event) {
        ...
        var deleteUrl = '{{ route("options.destroy", ":id") }}';
