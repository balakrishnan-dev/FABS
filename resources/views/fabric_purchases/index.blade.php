                            ...
                            <div id="customerList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <a href="{{ route('fabric-purchases.create') }}" class="btn btn-success add-btn btn-sm">
                                ...
                                <div class="table-responsive">
                                    <table class="table align-middle table-nowrap" id="yarn-purchasesTable">
...
$(function () {
    ...
    var table = $('#yarn-purchasesTable').DataTable({
    processing: true,
    serverSide: true,
    lengthChange: true,
    searching: true,
    ...
    scrollX: true,
    scrollCollapse: true,
    ajax: "{{ route('yarn-purchases.data') }}",
    ...
    $('#edityarnPurchasesForm').on('submit', function(e) {
        e.preventDefault();
        var form = $(this);
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#yarn-purchasesTable').DataTable().ajax.reload();
            ...
            error: function(xhr, status, error) {
                toastr.error('An error occurred while updating the yarn-purchases.', 'Error', {
                    positionClass: 'toast-top-right',
                    timeOut: 5000,
                });
            }
  ...
  $('#deleteRecordModal').on('show.bs.modal', function(event) {
        ...
        var deleteUrl = '{{ route("yarn-purchases.destroy", ":id") }}';
