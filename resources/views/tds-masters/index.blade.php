...
@include('template.form_sidebar')
            ...
            <div class="row">
                            <div class="col-lg-12">
                                        ...
                                        <div id="customerList">
                                            <div class="row g-4 mb-3">
                                                <div class="col-sm-auto">
                                                    <div>
                                                    <a href="{{ route('tds-masters.create') }}" class="btn btn-success add-btn btn-sm">
                                ...
                                <table class="table align-middle table-nowrap" id="TDSTable">
...
$(function () {
    ...
    $('#editTDSForm').on('submit', function(e) {
        e.preventDefault();
        var form = $(this);
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#TDSTable').DataTable().ajax.reload();
            ...
            error: function(xhr, status, error) {
                toastr.error('An error occurred while updating the tds-masters.', 'Error', {
                    positionClass: 'toast-top-right',
                    timeOut: 5000,
                });
            }
  ...
  $('#deleteRecordModal').on('show.bs.modal', function(event) {
        ...
        var deleteUrl = '{{ route("tds-masters.destroy", ":id") }}';
