...
@include('template.form_sidebar')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Year</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Year</a></li>
            ...
            <div class="row">
                            <div class="col-lg-12">
                                        ...
                                        <div id="customerList">
                                            <div class="row g-4 mb-3">
                                                <div class="col-sm-auto">
                                                    <div>
                                                    <a href="{{ route('year.create') }}" class="btn btn-success add-btn btn-sm">
                                ...
                                <table class="table align-middle table-nowrap" id="YearTable">
...
$(function () {
    ...
    paging: true,
    info: true,
    ajax: "{{ route('year.data') }}",
   
    columns: [
        { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false },
        { data: 'year_name', name: 'year_name', orderable: false },
    ...
    $('#edityearForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                toastr.error('An error occurred while updating the year.', 'Error', {
                    positionClass: 'toast-top-right',
                    timeOut: 5000,
                });
            }
  ...
  $('#deleteRecordModal').on('show.bs.modal', function(event) {
        ...
        var deleteUrl = '{{ route("year.destroy", ":id") }}';
