                            ...
                            <div id="BuyersList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <div>
                                            <a href="{{ route('buyers.create') }}" class="btn btn-success add-btn btn-sm">
                                ...
                                <table class="table align-middle table-nowrap" id="BuyersTable">
...
$(function () {
 ...
 // Handle edit form submission
    $('#editBuyerForm').on('submit', function(e) {
        e.preventDefault();
        var form = $(this);
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                toastr.error('An error occurred while updating the buyer.', 'Error', {
                    positionClass: 'toast-top-right',
                    timeOut: 5000,
                });
            }
    ...
    $('#deleteRecordModal').on('show.bs.modal', function(event) {
        ...
        var deleteUrl = '{{ route("buyers.destroy", ":id") }}';
