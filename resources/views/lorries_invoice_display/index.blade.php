                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">Lorry Invoice Display</a></li>
                                ...
                                <div id="customerList">
                                    <div class="row g-4 mb-3">
                                        <div class="col-sm-auto">
                                            <div>
                                                <a href="{{ route('lorries_invoice_display.create') }}" class="btn btn-success add-btn btn-sm">
    ...
    <script>
    $(function () {
    var table = $('#lorriesInvoiceDisplayTable').DataTable({
        processing: true,
        serverSide: true,
        ...
        $('#editlorriesForm').on('submit', function(e) {
            e.preventDefault();
            var form = $(this);
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#lorriesInvoiceDisplayTable').DataTable().ajax.reload();
                ...
                error: function(xhr, status, error) {
                    toastr.error('An error occurred while updating the lorries invoice display.', 'Error', {
                        positionClass: 'toast-top-right',
                        timeOut: 5000,
                    });
                }
    ...
    $('#deleteRecordModal').on('show.bs.modal', function(event) {
            ...
            var deleteUrl = '{{ route("lorries_invoice_display.destroy", ":id") }}';
