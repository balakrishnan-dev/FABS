            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Loom Types</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">DesLoom Typesigns</a></li>
                                <li class="breadcrumb-item active">Loom Types List</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div id="customerList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <a href="{{ route('loom-types.create') }}" class="btn btn-success add-btn btn-sm">
                                ...
                                <table class="table align-middle table-nowrap" id="loomtypeTable" style="width: 100%;">
...
<script>
$(function () {
    var table = $('#loomtypeTable').DataTable({
    processing: true,
    serverSide: true,
    lengthChange: true,
    searching: true,
   ...
   $('#editLoomTypeForm').on('submit', function(e) {
        e.preventDefault();
        var form = $(this);
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#loomtypeTable').DataTable().ajax.reload();
  ...
  $('#deleteRecordModal').on('show.bs.modal', function(event) {
        ...
        var deleteUrl = '{{ route("loom-types.destroy", ":id") }}';
