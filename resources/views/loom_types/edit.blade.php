                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 class="mb-sm-0">Loom Type Form</h4>
    ...
    <div class="col-xxl-6">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('loom-types.update', $loomType->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <input 
                        ...
                        value="{{ old('loom_type', $loomType->loom_type) }}"
                    >
                    @error('loom_type')
                ...
                <div class="mb-3">
                    ...
                    <input 
                        ...
                        value="{{ old('order_type', $loomType->order_type) }}"
                    >
                    @error('loom_type')
                        <div class="text-danger mt-1">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3">
                    <label for="order_type" class="form-label">Weaving Type</label>
                    <input 
                        type="text" 
                        name="weaving_type" 
                        id="weaving_type" 
                        class="form-control @error('weaving_type') is-invalid @enderror" 
                        value="{{ old('weaving_type', $loomType->weaving_type) }}"
                    >
                    @error('weaving_type')
                        <div class="text-danger mt-1">{{ $message }}</div>
                    @enderror
                        ...
                        <a href="{{ route('loom-types.index') }}" class="btn btn-secondary">Back</a>
                    </form>
                </div>
            </div>
        </div>
