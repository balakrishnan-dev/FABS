...
@include('template.form_sidebar')
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Ports List</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                            <div class="col-lg-12">
                                        ...
                                        <div id="customerList">
                                            <div class="row g-4 mb-3">
                                                <div class="col-sm-auto">
                                                    <div>
                                                    <a href="{{ route('ports.create') }}" class="btn btn-success add-btn btn-sm">
                                ...
                                <table class="table align-middle table-nowrap" id="portsTable">
...
$(function () {
    ...
    paging: true,
    info: true,
    ajax: "{{ route('ports.data') }}",
   
    columns: [
        { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false },
        { data: 'port_name', name: 'port_name', orderable: false },
    ...
    $('#editPortForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                toastr.error('An error occurred while updating the port.', 'Error', {
                    positionClass: 'toast-top-right',
                    timeOut: 5000,
                });
            }
  ...
  $('#deleteRecordModal').on('show.bs.modal', function(event) {
        ...
        var deleteUrl = '{{ route("ports.destroy", ":id") }}';
