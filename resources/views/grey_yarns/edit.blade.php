    ...
    <div class="col-xxl-6">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('grey-yarns.update', $greyYarn->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="mb-3">
            <label class="form-label">Type</label>
            <input type="text" name="type" class="form-control" value="{{ $greyYarn->type }}" required>
        </div>
        <div class="mb-3">
            <label class="form-label">Count</label>
            <input type="text" name="count" class="form-control" value="{{ $greyYarn->count }}" required>
        </div>
        <div class="mb-3">
            <label class="form-label">Shade</label>
            <input type="text" name="shade" class="form-control" value="{{ $greyYarn->shade }}" required>
        </div>
